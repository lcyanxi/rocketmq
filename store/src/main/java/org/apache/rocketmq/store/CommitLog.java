...
public class CommitLog {
    ...
    public PutMessageResult putMessage(final MessageExtBrokerInner msg) {
        ...
        if (tranType == MessageSysFlag.TRANSACTION_NOT_TYPE || tranType == MessageSysFlag.TRANSACTION_COMMIT_TYPE) {
            ...
            if (msg.getDelayTimeLevel() > 0) {
                ...
                // Backup real topic, queueId 备份原始的topic和queueId
        ...
        // 从mappedFileQueue获取最后一个mappedFile
    ...
    /**
     * 刷盘机制
     * @param result 消息写入到MappedFile的结果
     * @param putMessageResult 消息刷盘后的结果
     * @param messageExt 消息
     */
    ...
    class FlushRealTimeService extends FlushCommitLogService {
        ...
        public void run() {
            ...
            while (!this.isStopped()) {
                // 这个主要是等待方法，如果为true,则使用Thread.sleep,如果是false使用waitForRunning
    ...
    class DefaultAppendMessageCallback implements AppendMessageCallback {
        ...
        public AppendMessageResult doAppend(final long fileFromOffset, final ByteBuffer byteBuffer, final int maxBlank,
            ...
            // msgId生成 ：底层存储由16个字节表示 4字节IP + 4字节port + 8字节commitLog偏移地址
            ...
            // 如果该 MapperFile中剩余空间小于当前消息存储空间，返回END_OF_FILE
            ...
            final long beginTimeMills = CommitLog.this.defaultMessageStore.now();
            // Write messages to the queue buffer 将消息写入MapperFile中（内存中）
